...
// Chatwoot 設定
const CHATWOOT_TOKEN = "PNNnYX7mLWZbkCfDNSirrWp2"; // 你的訪問 token
const CHATWOOT_BASE = "https://app.chatwoot.com";   // SaaS 版 Chatwoot 網域
  ...
  try {
    ...
    (async () => {
      try {
        ...
        // ✅ 防呆：確認 accountId 和 conversationId 存在
        if (!accountId || !conversationId) {
          console.error("缺少必要的 Chatwoot 參數:", { accountId, conversationId });
          return;
        }
